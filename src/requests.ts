...
export interface ParamsTitleblacklist extends Params {
    tbtitle: string;
    tbaction?: "create" | "createpage" | "createtalk" | "edit" | "move" | "new-account" | "upload" | string;
...
export function cirrusConfigDump(params: ParamsCirrusConfigDump): Request<ParamsCirrusConfigDump> {
    return [false, { ...params, action: "cirrus-config-dump" }];
}

export function cirrusMappingDump(params: ParamsCirrusMappingDump): Request<ParamsCirrusMappingDump> {
    return [false, { ...params, action: "cirrus-mapping-dump" }];
}

export function cirrusProfilesDump(params: ParamsCirrusProfilesDump): Request<ParamsCirrusProfilesDump> {
    return [false, { ...params, action: "cirrus-profiles-dump" }];
}

export function cirrusSettingsDump(params: ParamsCirrusSettingsDump): Request<ParamsCirrusSettingsDump> {
...
export function flowParsoidUtils(params: ParamsFlowParsoidUtils): Request<ParamsFlowParsoidUtils> {
...
export function recordLint(params: ParamsRecordLint): Request<ParamsRecordLint> {
...
export function sanitizeMapdata(params: ParamsSanitizeMapdata): Request<ParamsSanitizeMapdata> {
    return [true, { ...params, action: "sanitize-mapdata" }];
}

export function scribuntoConsole(params: ParamsScribuntoConsole): Request<ParamsScribuntoConsole> {
...
export function webappManifest(params: ParamsWebappManifest): Request<ParamsWebappManifest> {
